...
LF=$(printf '\\\012_')
LF=${LF%_}
EXTENSION_NAME="Speech Recognition (Watson)"
EXTENSION_ID=watsonstt2scratch
COLLABORATOR="IBM"
...
# modify the url in index.js-------------------
URL=$1
mv ${EXTENSION_ID}/scratch-vm/src/extensions/scratch3_${EXTENSION_ID}/index.js ${EXTENSION_ID}/scratch-vm/src/extensions/scratch3_${EXTENSION_ID}/index.js_orig
sed -e "s|^const TOKENJSON_URL = 'http://localhost:30000/WatsonToken.json';$|const TOKENJSON_URL = '${URL}';|g" ${EXTENSION_ID}/scratch-vm/src/extensions/scratch3_${EXTENSION_ID}/index.js_orig > ${EXTENSION_ID}/scratch-vm/src/extensions/scratch3_${EXTENSION_ID}/index.js 
# modified-------------------
